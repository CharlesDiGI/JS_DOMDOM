...
let myPElt = document.getElementsByTagName("p");
console.log(myPElt.length);


console.log("Quel est le contenu texte de l'élément portant l'id coucou ? Imprime-le dans la console.");
let myCoucouElt = document.getElementById("coucou");
console.log(myCoucouElt.innerText);


console.log("Quelle est l'URL vers laquelle pointe le 3ème élément <a> de la page HTML ? Imprime-la dans la console.");
let myAElt = document.getElementsByTagName("a");
for (i = 0; i < myAElt.length; i++) {
    i == 2 ? console.log(myAElt[i].href) : "";
};


console.log("Combien d'éléments portent la classe compte-moi ? Imprime le résultat dans la console.");
let myCompteElt = document.getElementsByClassName("compte-moi");
console.log(myCompteElt.length);


console.log("Combien d'éléments <li> portent la classe compte-moi ? Imprime le résultat dans la console.");
// let myLiAElt = document.getElementsByTagName("li");
let myLiCompteElt = document.querySelectorAll("li.compte-moi");
console.log(myLiCompteElt.length);
...
let myOlLiCompteElt = document.querySelectorAll("ol > li.compte-moi");
console.log(myOlLiCompteElt.length);
...
let myDivElt = document.querySelectorAll("div > ul")[1] ;
console.log(myDivElt.childNodes[1].innerText);